...
class PowerOperation(FlopOperation):
    ...
    FLOPS_PER_SQRT = 20 # As per empirical results in similar implementations, e.g. https://discourse.julialang.org/t/how-many-flops-does-it-take-to-compute-a-square-root/89027
